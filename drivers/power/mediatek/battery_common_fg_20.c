...
extern int dt_charge_full_design;
extern int dt_charge_full;
...
static void battery_update(struct battery_data *bat_data)
{
	...
	bat_data->charge_full_design = dt_charge_full_design;  //add by dengwenhao use dts info
	bat_data->charge_full = dt_charge_full;
